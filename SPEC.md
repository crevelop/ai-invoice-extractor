...
4. **Cost table:** $/document by model tier (e.g., Haiku-class vs Sonnet-class vs GPT-4o-mini-class), accuracy vs. cost trade-off.
   - **Verification ablation:** each config run with and without the verification step — does gate quality improve enough to justify the extra call? This table answers it with data.
